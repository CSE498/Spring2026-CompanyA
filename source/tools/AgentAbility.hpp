 ...
 * @author lrima
 *
 * This is a preliminary placeholder file to represent some things the agent may or may not be able to do
 * this information is used in path finding to know whether the agent can walk on certain tiles or not.
 */
