 ...
 * @details Callers may also provide categories at runtime through the string overload of Log().
 */
...
public:
    /**
     * @brief constructor for OutputManager
     */
    OutputManager();
...
private:
     ...
     */
    std::string FormatLine(LogLevel level, std::string_view category, std::string_view message, bool includeTimestamp,
