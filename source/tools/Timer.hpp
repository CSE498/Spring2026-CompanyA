...
// A struct to hold timer information. Includes the starting time point, a
// boolean for whether the timer is running, and the total accumulated duration
// for the timer.
struct TimerInfo {
...
public:
  ...
  /**
   * Returns whether the timer with the provided name is currently running. If
   * the timer doesn't exist, returns false.
   */
