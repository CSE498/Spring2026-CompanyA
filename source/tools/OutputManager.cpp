...
*/
std::string cse498::OutputManager::FormatLine
(
    LogLevel level,
...
*/
void cse498::OutputManager::Log(std::string_view message)
{
    Log(LogLevel::Info, DEFAULT_RUNTIME_CATEGORY, message);
}
