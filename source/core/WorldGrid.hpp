...
protected:
  ...
  std::vector<size_t> cells; ///< Matrix of world cells, by rows, top to bottom;
                             ///< value is cell ID.
...
public:
   ...
   * TODO: This needs to be changed when this whole class changes. This function
   * should be simpler
   * TODO: This was done based on current structure which is not ideal for this
   * at all.
