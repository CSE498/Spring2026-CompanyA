...
private:
     ...
     * @return BuildingUpgrade struct for the next upgrade (holds type of items and quantity needed)
     */
     ...
     * @return void if the upgrade is successful, UpgradeRejectionType describing why it failed
     */
...
public:
    ...
    */
     ...
     * @return void if the upgrade is successful, UpgradeRejectionType if not successful
     */
