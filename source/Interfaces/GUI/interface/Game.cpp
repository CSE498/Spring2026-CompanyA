...
bool Game::Initialize() {
    ...
    if (!LoadCheck("skeleton", std::string(ASSETS_DIR) + "/" + "agents/monsters/agent_monster_skeleton.png"))
        return false;
    if (!LoadCheck("goblin", std::string(ASSETS_DIR) + "/" + "agents/monsters/agent_monster_goblin.png"))
        return false;
    if (!LoadCheck("dun_monster", std::string(ASSETS_DIR) + "/" + "agents/monsters/agent_monster_skeleton.png"))
        return false;

    // --- Level 1 floors (forest) ---
    if (!LoadCheck("floor_l1v1", std::string(ASSETS_DIR) + "/" + "world/forest/floor_tiles/tile_grass_1.png"))
        return false;
    if (!LoadCheck("floor_l1v2", std::string(ASSETS_DIR) + "/" + "world/forest/floor_tiles/tile_grass_2.png"))
        return false;
    if (!LoadCheck("floor_l1v3", std::string(ASSETS_DIR) + "/" + "world/forest/floor_tiles/tile_grass_3.png"))
        return false;
    if (!LoadCheck("floor_l1v4", std::string(ASSETS_DIR) + "/" + "world/forest/floor_tiles/tile_grass_4.png"))
        return false;
    if (!LoadCheck("floor_l1v5", std::string(ASSETS_DIR) + "/" + "world/forest/floor_tiles/tile_grass_5.png"))
        return false;
    // --- Level 2 floors (cave) ---
    if (!LoadCheck("floor_l2v1", std::string(ASSETS_DIR) + "/" + "world/cave/floor_tiles/tile_cave_1.png"))
        return false;
    if (!LoadCheck("floor_l2v2", std::string(ASSETS_DIR) + "/" + "world/cave/floor_tiles/tile_cave_2.png"))
        return false;
    if (!LoadCheck("floor_l2v3", std::string(ASSETS_DIR) + "/" + "world/cave/floor_tiles/tile_cave_3.png"))
        return false;
    if (!LoadCheck("floor_l2v4", std::string(ASSETS_DIR) + "/" + "world/cave/floor_tiles/tile_cave_4.png"))
        return false;
    if (!LoadCheck("floor_l2v5", std::string(ASSETS_DIR) + "/" + "world/cave/floor_tiles/tile_cave_5.png"))
        return false;
    // --- Level 3 floors (dungeon) ---
    if (!LoadCheck("floor_l3v1", std::string(ASSETS_DIR) + "/" + "world/dungeon/floor_tiles/tile_stoneBrick_1.png"))
        return false;
    if (!LoadCheck("floor_l3v2", std::string(ASSETS_DIR) + "/" + "world/dungeon/floor_tiles/tile_stoneBrick_2.png"))
        return false;
    if (!LoadCheck("floor_l3v3", std::string(ASSETS_DIR) + "/" + "world/dungeon/floor_tiles/tile_stoneBrick_3.png"))
        return false;
    if (!LoadCheck("floor_l3v4", std::string(ASSETS_DIR) + "/" + "world/dungeon/floor_tiles/tile_stoneBrick_4.png"))
        return false;
    if (!LoadCheck("floor_l3v5", std::string(ASSETS_DIR) + "/" + "world/dungeon/floor_tiles/tile_stoneBrick_5.png"))
        return false;
    // --- Level 4 floors (castle) ---
    if (!LoadCheck("floor_l4v1", std::string(ASSETS_DIR) + "/" + "world/castle/floor_tiles/tile_wood_1.png"))
        return false;
    if (!LoadCheck("floor_l4v2", std::string(ASSETS_DIR) + "/" + "world/castle/floor_tiles/tile_wood_2.png"))
        return false;
    if (!LoadCheck("floor_l4v3", std::string(ASSETS_DIR) + "/" + "world/castle/floor_tiles/tile_wood_3.png"))
        return false;
    if (!LoadCheck("floor_l4v4", std::string(ASSETS_DIR) + "/" + "world/castle/floor_tiles/tile_wood_4.png"))
        return false;
    if (!LoadCheck("floor_l4v5", std::string(ASSETS_DIR) + "/" + "world/castle/floor_tiles/tile_wood_5.png"))
        return false;

    // --- Generic wall (#) ---
    if (!LoadCheck("wall", std::string(ASSETS_DIR) + "/" + "gui/black_tile.png"))
        return false;

    // --- Level 1 walls (forest) ---
    if (!LoadCheck("wall_l1v1", std::string(ASSETS_DIR) + "/" + "world/forest/walls/external/border_top_forest.png"))
        return false;
    if (!LoadCheck("wall_l1v2", std::string(ASSETS_DIR) + "/" + "world/forest/walls/external/border_bottom_forest.png"))
        return false;
    if (!LoadCheck("wall_l1v13", std::string(ASSETS_DIR) + "/" + "world/forest/walls/external/border_left_forest.png"))
        return false;
    if (!LoadCheck("wall_l1v4", std::string(ASSETS_DIR) + "/" + "world/forest/walls/external/border_right_forest.png"))
        return false;
    if (!LoadCheck("wall_l1v5", std::string(ASSETS_DIR) + "/" + "world/forest/walls/external/border_top_forest.png"))
        return false;
    if (!LoadCheck("wall_l1v6", std::string(ASSETS_DIR) + "/" + "world/forest/walls/external/border_top_forest.png"))
        return false;
    if (!LoadCheck("wall_l1v7", std::string(ASSETS_DIR) + "/" + "world/forest/walls/external/door_left_forest.png"))
        return false;
    if (!LoadCheck("wall_l1v8", std::string(ASSETS_DIR) + "/" + "world/forest/walls/external/door_right_forest.png"))
        return false;
    // --- Level 2 walls (cave) ---
    if (!LoadCheck("wall_l2v1", std::string(ASSETS_DIR) + "/" + "world/cave/walls/external/border_top_cave.png"))
        return false;
    if (!LoadCheck("wall_l2v2", std::string(ASSETS_DIR) + "/" + "world/cave/walls/external/border_bottom_cave.png"))
        return false;
    if (!LoadCheck("wall_l2v3", std::string(ASSETS_DIR) + "/" + "world/cave/walls/external/border_left_cave.png"))
        return false;
    if (!LoadCheck("wall_l2v4", std::string(ASSETS_DIR) + "/" + "world/cave/walls/external/border_right_cave.png"))
        return false;
    if (!LoadCheck("wall_l2v5", std::string(ASSETS_DIR) + "/" + "world/cave/walls/external/border_top_cave.png"))
        return false;
    if (!LoadCheck("wall_l2v6", std::string(ASSETS_DIR) + "/" + "world/cave/walls/external/border_top_cave.png"))
        return false;
    if (!LoadCheck("wall_l2v7", std::string(ASSETS_DIR) + "/" + "world/cave/walls/external/door_left_cave.png"))
        return false;
    if (!LoadCheck("wall_l2v8", std::string(ASSETS_DIR) + "/" + "world/cave/walls/external/door_right_cave.png"))
        return false;
    // --- Level 3 walls (dungeon) ---
    if (!LoadCheck("wall_l3v1", std::string(ASSETS_DIR) + "/" + "world/dungeon/walls/external/border_top_dungeon.png"))
        return false;
    if (!LoadCheck("wall_l3v2",
                   std::string(ASSETS_DIR) + "/" + "world/dungeon/walls/external/border_bottom_dungeon.png"))
        return false;
    if (!LoadCheck("wall_l3v3", std::string(ASSETS_DIR) + "/" + "world/dungeon/walls/external/border_left_dungeon.png"))
        return false;
    if (!LoadCheck("wall_l3v4",
                   std::string(ASSETS_DIR) + "/" + "world/dungeon/walls/external/border_right_dungeon.png"))
        return false;
    if (!LoadCheck("wall_l3v5", std::string(ASSETS_DIR) + "/" + "world/dungeon/walls/external/border_top_dungeon.png"))
        return false;
    if (!LoadCheck("wall_l3v6", std::string(ASSETS_DIR) + "/" + "world/dungeon/walls/external/border_top_dungeon.png"))
        return false;
    if (!LoadCheck("wall_l3v7", std::string(ASSETS_DIR) + "/" + "world/dungeon/walls/external/door_left_dungeon.png"))
        return false;
    if (!LoadCheck("wall_l3v8", std::string(ASSETS_DIR) + "/" + "world/dungeon/walls/external/door_right_dungeon.png"))
        return false;
    // --- Level 4 walls (castle) ---
    if (!LoadCheck("wall_l4v1", std::string(ASSETS_DIR) + "/" + "world/castle/walls/external/border_top_castle.png"))
        return false;
    if (!LoadCheck("wall_l4v2", std::string(ASSETS_DIR) + "/" + "world/castle/walls/external/border_bottom_castle.png"))
        return false;
    if (!LoadCheck("wall_l4v3", std::string(ASSETS_DIR) + "/" + "world/castle/walls/external/border_left_castle.png"))
        return false;
    if (!LoadCheck("wall_l4v4", std::string(ASSETS_DIR) + "/" + "world/castle/walls/external/border_right_castle.png"))
        return false;
    if (!LoadCheck("wall_l4v5", std::string(ASSETS_DIR) + "/" + "world/castle/walls/external/border_top_castle.png"))
        return false;
    if (!LoadCheck("wall_l4v6", std::string(ASSETS_DIR) + "/" + "world/castle/walls/external/border_top_castle.png"))
        return false;
    if (!LoadCheck("wall_l4v7", std::string(ASSETS_DIR) + "/" + "world/castle/walls/external/door_left_castle.png"))
        return false;
    if (!LoadCheck("wall_l4v8", std::string(ASSETS_DIR) + "/" + "world/castle/walls/external/door_right_castle.png"))
        return false;

    // --- Shared special tiles ---
    if (!LoadCheck("wall_trap", std::string(ASSETS_DIR) + "/" + "world/dungeon/floor_tiles/tile_stoneBrick_3.png"))
        return false;
    if (!LoadCheck("wall_loot", std::string(ASSETS_DIR) + "/" + "items/item_potion_defense.png"))
        return false;
    if (!LoadCheck("wall_skeleton", std::string(ASSETS_DIR) + "/" + "agents/monsters/agent_monster_skeleton.png"))
        return false;
    if (!LoadCheck("wall_goblin", std::string(ASSETS_DIR) + "/" + "agents/monsters/agent_monster_goblin.png"))
        return false;
    // KAREN: Changes to match DungeonWorld
    // if (!LoadCheck("wall_secret", std::string(ASSETS_DIR) + "/" +
    // "world/dungeon/walls/external/door_right_dungeon.png")) return false; if (!LoadCheck("exit",
    // std::string(ASSETS_DIR) + "/" +  "world/dungeon/walls/external/door_left_dungeon.png")) return false; Secret
    // doors
    if (!LoadCheck("wall_secret_top", std::string(ASSETS_DIR) + "/world/dungeon/walls/external/door_right_dungeon.png"))
        return false;
    if (!LoadCheck("wall_secret_bottom",
                   std::string(ASSETS_DIR) + "/world/dungeon/walls/external/door_right_dungeon.png"))
        return false;
    if (!LoadCheck("wall_secret_left",
                   std::string(ASSETS_DIR) + "/world/dungeon/walls/external/door_right_dungeon.png"))
        return false;
    if (!LoadCheck("wall_secret_right",
                   std::string(ASSETS_DIR) + "/world/dungeon/walls/external/door_right_dungeon.png"))
        return false;
    // Exits
    if (!LoadCheck("exit_l1", std::string(ASSETS_DIR) + "/world/dungeon/walls/external/door_left_dungeon.png"))
        return false;
    if (!LoadCheck("exit_l2", std::string(ASSETS_DIR) + "/world/dungeon/walls/external/door_left_dungeon.png"))
        return false;
    if (!LoadCheck("exit_l3", std::string(ASSETS_DIR) + "/world/dungeon/walls/external/door_left_dungeon.png"))
        return false;
    if (!LoadCheck("exit_l4", std::string(ASSETS_DIR) + "/world/dungeon/walls/external/door_left_dungeon.png"))
        return false;

    // Item sprites — keyed by item name to match what Inventory stores
    if (!LoadCheck("Sword", std::string(ASSETS_DIR) + "/" + "items/item_sword_1.png"))
        return false;
    if (!LoadCheck("Sword +1", std::string(ASSETS_DIR) + "/" + "items/item_sword_1.png"))
        return false;
    if (!LoadCheck("Sword +2", std::string(ASSETS_DIR) + "/" + "items/item_sword_1.png"))
        return false;
    if (!LoadCheck("Sword +3", std::string(ASSETS_DIR) + "/" + "items/item_sword_1.png"))
        return false;
    if (!LoadCheck("Sword +4", std::string(ASSETS_DIR) + "/" + "items/item_sword_1.png"))
        return false;
    if (!LoadCheck("Sword +5", std::string(ASSETS_DIR) + "/" + "items/item_sword_1.png"))
        return false;

    if (!LoadCheck("Bow", std::string(ASSETS_DIR) + "/" + "items/item_bow_1.png"))
        return false;
    if (!LoadCheck("Bow +1", std::string(ASSETS_DIR) + "/" + "items/item_bow_1.png"))
        return false;
    if (!LoadCheck("Bow +2", std::string(ASSETS_DIR) + "/" + "items/item_bow_1.png"))
        return false;
    if (!LoadCheck("Bow +3", std::string(ASSETS_DIR) + "/" + "items/item_bow_1.png"))
        return false;
    if (!LoadCheck("Bow +4", std::string(ASSETS_DIR) + "/" + "items/item_bow_1.png"))
        return false;
    if (!LoadCheck("Bow +5", std::string(ASSETS_DIR) + "/" + "items/item_bow_1.png"))
        return false;

    if (!LoadCheck("Healing Potion", std::string(ASSETS_DIR) + "/" + "items/item_potion_healing.png"))
        return false;
    if (!LoadCheck("Defense Potion", std::string(ASSETS_DIR) + "/" + "items/item_potion_defense.png"))
        return false;
    if (!LoadCheck("Speed Potion", std::string(ASSETS_DIR) + "/" + "items/item_potion_speed.png"))
        return false;

    if (!LoadCheck("Axe", std::string(ASSETS_DIR) + "/" + "items/item_axe.png"))
        return false;
    if (!LoadCheck("Pickaxe", std::string(ASSETS_DIR) + "/" + "items/item_pickaxe.png"))
        return false;
    if (!LoadCheck("Shovel", std::string(ASSETS_DIR) + "/" + "items/item_shovel.png"))
        return false;
    ...
    // Merchant Items
    if (!LoadCheck("Crown", std::string(ASSETS_DIR) + "/" + "items/item_crown.png"))
        return false;
            ...
            switch (event.key.keysym.sym) {
                ...
                case SDLK_UP:
                    ...
                    if (mState == GameState::TRADING && mActiveMerchant) {
                        ...
                        if (count > 0)
                            mTradeMenuSelection = (mTradeMenuSelection - 1 + count) % count;
                    }
                        ...
                        if (mTradeBuyMode) {
                            ...
                            for (int i = 0; i < static_cast<int>(offers.size()); ++i) {
                                ...
                                if (displayIndex == mTradeMenuSelection) {
                                    TradeResult result =
                                            mActiveMerchant->BuyFromMerchant(*mOverworldPlayer, offer.mItemName, 1);
                                    if (result.mStatus == TradeStatus::Success) {
                                        mPickupMessage = "Bought " + offer.mItemName + " for " +
                                                         std::to_string(offer.mBuyPrice) + " gold";
                                    } else {
                            ...
                            if (mTradeMenuSelection >= 0 && mTradeMenuSelection < static_cast<int>(offers.size())) {
                                ...
                                bool validType = true;
                                if (offer.mItemName == "Wood")
                                    type = ItemType::Wood;
                                else if (offer.mItemName == "Stone")
                                    type = ItemType::Stone;
                                else if (offer.mItemName == "Metal")
                                    type = ItemType::Metal;
                                else
                                    validType = false;
                ...
                case SDLK_d:
                    if (mState == GameState::OVERWORLD || mState == GameState::DUNGEON) {
                        if (mShowBackpack) {
                            ...
                            switch (event.key.keysym.sym) {
                                case SDLK_w:
                                    mBackpackCursorRow = (mBackpackCursorRow - 1 + rows) % rows;
                                    break;
                                case SDLK_s:
                                    mBackpackCursorRow = (mBackpackCursorRow + 1) % rows;
                                    break;
                                case SDLK_a:
                                    mBackpackCursorCol = (mBackpackCursorCol - 1 + cols) % cols;
                                    break;
                                case SDLK_d:
                                    mBackpackCursorCol = (mBackpackCursorCol + 1) % cols;
                                    break;
                                default:
                                    break;
                            }
                ...
                case SDLK_e:
                    if (mState == GameState::TRADING) {
                        ...
                        std::array<WorldPosition, 4> adjacent = {playerPos.Up(), playerPos.Down(), playerPos.Left(),
                                                                 playerPos.Right()};
                                            ...
                                            if (upgradeInfo) {
                                                ...
                                                if (inv.HasEnough(needed, cost)) {
                                                    ...
                                                    mPickupMessage = building->GetName() + " needs " +
                                                                     std::to_string(cost) + " " +
                                                                     std::string(ItemTypeToString(needed)) + " (have " +
                                                                     std::to_string(inv.GetAmount(needed)) + ")";
                                                }
                                                mPickupMessageTime = SDL_GetTicks();
                                            }
                                        }
                ...
                case SDLK_9:
                    if (mShowBackpack && (mState == GameState::OVERWORLD || mState == GameState::DUNGEON)) {
                        ...
                        size_t hotbar_slot = (event.key.keysym.sym == SDLK_0)
                                                     ? 9
                                                     : static_cast<size_t>(event.key.keysym.sym - SDLK_1);
                        if (hotbar_slot < Inventory::HOTBAR_SIZE) {
                            ...
                            Inventory& inv = (mState == GameState::OVERWORLD) ? mOverworldPlayer->GetInventory()
...
void Game::RenderDungeon() {
    ...
    RenderPickupMessage();
    if (mShowBackpack)
        RenderBackpack(mDungeonPlayer->GetInventory());
}
...
void Game::RenderStats() {
    ...
    for (const StatSummary& stat: mDashboardSnapshot.numericStats) {
        ...
        std::string detail;
        if (stat.minValue)
            detail += "Min: " + std::to_string(static_cast<int>(*stat.minValue)) + "  ";
        if (stat.maxValue)
            detail += "Max: " + std::to_string(static_cast<int>(*stat.maxValue)) + "  ";
        if (stat.meanValue)
            detail += "Mean: " + std::to_string(static_cast<int>(*stat.meanValue));
        if (!detail.empty()) {
...
void Game::RenderTrading() {
    ...
    if (mTradeBuyMode) {
        ...
        for (int i = 0; i < static_cast<int>(offers.size()); ++i) {
            ...
            size_t have = 0;
            if (offer.mItemName == "Wood")
                have = worldInv.GetAmount(ItemType::Wood);
            else if (offer.mItemName == "Stone")
                have = worldInv.GetAmount(ItemType::Stone);
            else if (offer.mItemName == "Metal")
                have = worldInv.GetAmount(ItemType::Metal);

            std::string line = offer.mItemName + "  -  " + std::to_string(offer.mSellPrice) + " gold  (have " +
                               std::to_string(have) + ")";
