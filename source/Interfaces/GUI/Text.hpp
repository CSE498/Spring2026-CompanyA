 ...
 *
 * This class handles text properties such as font, color, size, and style
 * (bold/italic), providing a simplified interface for rendering text in
 * SDL-based GUI applications. It abstracts away the complexities of SDL_ttf
 * font rendering.
 */
...
public:
   ...
   * @note Asserts if point_size <= 0; Passing a non-positive value is a
   * programmer error.
   */
