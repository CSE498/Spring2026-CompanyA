...
private:
     ...
     */
    [[nodiscard]] size_t ToIndex(size_t x, size_t y) const { return x + y * mWidth; }
...
public:
     ...
     */
    [[nodiscard]] bool IsValid(size_t x, size_t y) const { return x < mWidth && y < mHeight; }
     ...
     */
    void DrawViewport(const ImageManager& image_manager, int cam_x, int cam_y, int viewport_w, int viewport_h) const;
};
