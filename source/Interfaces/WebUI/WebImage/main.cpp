...
int main() {
  ...
  img1 = new WebImage("https://via.placeholder.com/200x150",
                      "Placeholder 200x150");
  ...
  img2 =
      new WebImage("https://via.placeholder.com/100x100", "Square Placeholder");
  ...
  std::cout << "Image 1 ID: " << img1->Id() << " (resize with aspect ratio)"
            << std::endl;
  std::cout << "Image 2 ID: " << img2->Id() << " (stretched, 60% opacity)"
            << std::endl;
  std::cout << "Image 3 ID: " << img3->Id() << " (error -> blank rect)"
            << std::endl;
