...
int main() {
  ...
  sImg1 = std::make_unique<WebImage>(
      "https://via.placeholder.com/200x150", "Placeholder 200x150");
  sImg1->Resize(200, 150, true);  // Scale to fit, keep aspect ratio
  sImg1->SetOnLoadCallback([]() {
    std::cout << "Image 1 loaded successfully!" << std::endl;
  });
  sImg1->SetOnErrorCallback([]() {
  ...
  sImg2 = std::make_unique<WebImage>(
      "https://via.placeholder.com/100x100", "Square Placeholder");
  sImg2->SetSize(200, 100);  // Stretch to exact 200x100
  sImg2->SetOpacity(0.6);    // 60% transparent
  sImg2->SetOnLoadCallback([]() {
