...
void WebLayout::SetJustification(Justification j) noexcept { mJustification = j; }
...
void WebLayout::SetBackgroundColor(const std::string& color) noexcept { mBackgroundColor = color; }

/// @brief Sets the border color of the layout container.
/// @param color CSS color string.
void WebLayout::SetBorderColor(const std::string& color) noexcept { mBorderColor = color; }
...
void WebLayout::SetBoxShadow(const std::string& shadow) noexcept { mBoxShadow = shadow; }
...
void WebLayout::MountToLayout(WebLayout& parent, Alignment align) noexcept { parent.AddElement(this, align); }
...
void WebLayout::ApplyLayout(val style) noexcept {
    ...
    switch (mType) {
        ...
        case LayoutType::Free:
            ...
            style.set("display", mIsVisible ? std::string("block") : std::string("none"));
            break;
        case LayoutType::Horizontal:
            style.set("display", mIsVisible ? std::string("flex") : std::string("none"));
        ...
        case LayoutType::Grid:
            style.set("display", mIsVisible ? std::string("grid") : std::string("none"));
            style.set("alignItems", getAlignItemsStr(mAlignItems));
