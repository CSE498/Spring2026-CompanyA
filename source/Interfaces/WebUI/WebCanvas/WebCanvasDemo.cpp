...
static void demo_frame(void* /*arg*/) {
    ...
    g_canvas->DrawRect(10.0f, 4.0f, 260.0f, 22.0f, "#1e2230");
    g_canvas->DrawText(14.0f, 20.0f,
                       "Section A: immediate-mode primitives", "#6a8faf", 13.0f);
    ...
    g_canvas->DrawRect(500.0f, 4.0f, 390.0f, 22.0f, "#1e2230");
    g_canvas->DrawText(504.0f, 20.0f,
                       "Section B: real WebImage / WebButton / WebTextbox", "#af8f6a", 13.0f);
...
int main() {
    ...
    img_a->SetSize(80, 80);
    img_a->SetPlaceholderColor("#1a5276");
    ...
    img_b->SetSize(80, 80);
    img_b->SetPlaceholderColor("#145a32");
    ...
    img_c->SetSize(80, 80);
    img_c->SetPlaceholderColor("#6e2f1a");
    ...
    btn_start->SetBackgroundColor("#1e8449");
    btn_start->SetTextColor("#ffffff");
    ...
    btn_pause->SetBackgroundColor("#1a5276");
    btn_pause->SetTextColor("#ffffff");
