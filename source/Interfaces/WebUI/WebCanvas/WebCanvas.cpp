...
// --------------------
    ...
    void webcanvas__draw_polygon(const char* id, const float* coordsXY, int count, const char* strokeColor,
                                 float lineWidth, const char* fillColor);
    ...
    void WebCanvas::DrawCircle(float centerX, float centerY, float radius, const std::string& strokeColor,
                               float lineWidth, const std::string& fillColor) {
#ifdef __EMSCRIPTEN__
        webcanvas__draw_circle(mId.c_str(), centerX, centerY, radius, strokeColor.c_str(), lineWidth,
                               fillColor.c_str());
#else
        (void) centerX;
        (void) centerY;
    ...
    void WebCanvas::DrawPolygon(const std::vector<Vec2>& points, const std::string& strokeColor, float lineWidth,
        ...
        webcanvas__draw_polygon(mId.c_str(), coords.data(), static_cast<int>(points.size()), strokeColor.c_str(),
