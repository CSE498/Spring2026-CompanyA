 ...
 */
enum class TradeStockMode { Unlimited, Limited };
...
struct TradeOffer {
    ...
    [[nodiscard]] bool IsUnlimited() const { return mStockMode == TradeStockMode::Unlimited; }

    [[nodiscard]] bool HasEnough(std::size_t quantity) const { return IsUnlimited() || mStock >= quantity; }
