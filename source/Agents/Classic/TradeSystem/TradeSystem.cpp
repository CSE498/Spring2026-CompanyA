...
namespace cse498 {
TradeResult TradeSystem::BuyItem(const WorldBase& world, PlayerAgent& player, MerchantAgent& merchant,
...
TradeResult TradeSystem::SellItem(const WorldBase& world, PlayerAgent& player, MerchantAgent& merchant,
                                  TradeOffer& offer, std::size_t quantity) {
