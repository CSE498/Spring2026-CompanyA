...
public:
    ...
    /// @brief
    /// @return
    [[nodiscard]] std::vector<std::string> GetCurrentRoom() { return current_room; }
    ...
    /// @brief
    /// @return
    [[nodiscard]] int GetRoomWidth() { return (current_room)[0].length(); }

    /// @brief
    /// @return
    [[nodiscard]] int GetRoomHeight() { return (current_room).size(); }
