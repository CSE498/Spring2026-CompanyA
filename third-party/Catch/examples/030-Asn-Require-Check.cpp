...
// Compile & run:
// - g++ -std=c++11 -Wall -I$(CATCH_SINGLE_INCLUDE) -o 030-Asn-Require-Check
// 030-Asn-Require-Check.cpp 000-CatchMain.o && 030-Asn-Require-Check --success
// - cl -EHsc -I%CATCH_SINGLE_INCLUDE% 030-Asn-Require-Check.cpp
// 000-CatchMain.obj && 030-Asn-Require-Check --success
...
// 030-Asn-Require-Check.cpp:42: warning: 'REQUIRE_FALSE stops at first
// failure:' 030-Asn-Require-Check.cpp:44: failed: !(one() == "1") for: !("1" ==
// "1") 030-Asn-Require-Check.cpp:49: warning: 'CHECK_FALSE continues after
// failure:' 030-Asn-Require-Check.cpp:51: failed: !(one() == "1") for: !("1" ==
// "1") 030-Asn-Require-Check.cpp:52: passed: !(one() != "1") for: !("1" != "1")
