// include set of usage tests into one file for compiler performance test
// purposes This whole file can now be included multiple times in 10.tests.cpp,
// and *that* file included multiple times (in 100.tests.cpp)
