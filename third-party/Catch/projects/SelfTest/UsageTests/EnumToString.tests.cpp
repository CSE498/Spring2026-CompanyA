...
CATCH_REGISTER_ENUM( EnumClass3,
                     EnumClass3::Value1,
                     EnumClass3::Value2,
                     EnumClass3::Value3 )
...
TEST_CASE(
    ...
    REQUIRE( stringify( EnumClass3::Value4 ) ==
...
// Important!: This macro must appear at top level scope - not inside a
// namespace You can fully qualify the names, or use a using if you prefer
CATCH_REGISTER_ENUM( Bikeshed::Colours,
                     Bikeshed::Colours::Red,
                     Bikeshed::Colours::Green,
                     Bikeshed::Colours::Blue )

TEST_CASE( "Enums in namespaces can quickly have stringification enabled using "
           "REGISTER_ENUM" ) {
    using Catch::Detail::stringify;
