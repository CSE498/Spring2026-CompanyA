...
#    define CLASS_TEST_HELPERS_INCLUDED
        ...
        TEMPLATE_PRODUCT_TEST_CASE_METHOD_SIG(
            Template_Fixture_2,
            "A TEMPLATE_PRODUCT_TEST_CASE_METHOD_SIG based test run that "
            "succeeds",
        ...
        TEMPLATE_LIST_TEST_CASE_METHOD( Template_Fixture,
                                        "Template test case method with test "
                                        "types specified inside std::tuple",
                                        "[class][template][list]",
                                        MyTypes ) {
            REQUIRE( Template_Fixture<TestType>::m_a == 1 );
        }
