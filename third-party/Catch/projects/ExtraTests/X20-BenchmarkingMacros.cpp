...
// Test that the benchmarking support macros compile properly with the single
// header
...
TEST_CASE( "Benchmark factorial", "[benchmark]" ) {
    ...
    BENCHMARK( "factorial 14" ) { return factorial( 14 ); };
}
...
TEST_CASE( "Benchmark containers", "[.][benchmark]" ) {
    ...
    SECTION( "without generator" ) {
        ...
        SECTION( "XYZ" ) {
            ...
            BENCHMARK_ADVANCED( "Load up vector with chronometer" )(
