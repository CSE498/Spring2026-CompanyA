...
CATCH_TEST_CASE( "PrefixedMacros" ) {
    ...
    CATCH_CHECKED_IF( 1 == 1 ) { CATCH_SUCCEED( "don't care" ); }
    CATCH_CHECKED_ELSE( 1 == 1 ) { CATCH_SUCCEED( "don't care" ); }
...
CATCH_ANON_TEST_CASE() { CATCH_FAIL( "" ); }

// Missing:

//
// #define CATCH_TEST_CASE_METHOD( className, ... )
// INTERNAL_CATCH_TEST_CASE_METHOD( className, __VA_ARGS__ ) #define
// CATCH_METHOD_AS_TEST_CASE( method, ... ) INTERNAL_CATCH_METHOD_AS_TEST_CASE(
// method, __VA_ARGS__ ) #define CATCH_REGISTER_TEST_CASE( Function, ... )
...
// #define CATCH_GIVEN( desc )    INTERNAL_CATCH_DYNAMIC_SECTION( "   Given: "
// << desc ) #define CATCH_WHEN( desc )     INTERNAL_CATCH_DYNAMIC_SECTION( "
// When: " << desc ) #define CATCH_AND_WHEN( desc )
// INTERNAL_CATCH_DYNAMIC_SECTION( "And when: " << desc ) #define CATCH_THEN(
// desc )     INTERNAL_CATCH_DYNAMIC_SECTION( "    Then: " << desc ) #define
