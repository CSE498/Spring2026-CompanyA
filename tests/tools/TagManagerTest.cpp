...
SV(std::initializer_list<std::string_view> tags) {
...
TEST_CASE("TagManager: Query with empty include tag returns empty",
          "[TagManager]") {
  TagManager tm;
  TagManager::ObjectId a = 1;
...
TEST_CASE("TagManager: OnTagAdded makes HasTag true and Query returns owner",
          "[TagManager]") {
  TagManager tm;
  TagManager::ObjectId a = 1;
...
TEST_CASE("TagManager: Adding same tag twice does not duplicate results",
          "[TagManager]") {
  TagManager tm;
  TagManager::ObjectId a = 1;
...
TEST_CASE("TagManager: OnTagRemoved removes membership for that tag",
          "[TagManager]") {
  TagManager tm;
  TagManager::ObjectId a = 1;
...
TEST_CASE(
    "TagManager: Removing a non-existent tag does not crash and keeps state",
    "[TagManager]") {
  TagManager tm;
  TagManager::ObjectId a = 1;
...
TEST_CASE("TagManager: Excluding a tag that doesn't exist changes nothing",
          "[TagManager]") {
  TagManager tm;
  TagManager::ObjectId a = 1;
...
TEST_CASE("TagManager: Query with multiple include tags returns intersection",
          "[TagManager]") {
  TagManager tm;
  TagManager::ObjectId a = 1;
  TagManager::ObjectId b = 2;
...
TEST_CASE("TagManager: Query returns empty if any include tag missing globally",
          "[TagManager]") {
  TagManager tm;
  TagManager::ObjectId a = 1;
...
TEST_CASE("TagManager: Query with excludeTags filters out matches",
          "[TagManager]") {
  TagManager tm;
  TagManager::ObjectId a = 1;
  TagManager::ObjectId b = 2;
...
TEST_CASE(
    "TagManager: Query with empty includeTags uses universe then excludes",
    "[TagManager]") {
  TagManager tm;
  TagManager::ObjectId a = 1;
  TagManager::ObjectId b = 2;
...
TEST_CASE("TagManager: Universe keeps owners even if their last tag is removed",
          "[TagManager]") {
  TagManager tm;
  TagManager::ObjectId a = 1;
