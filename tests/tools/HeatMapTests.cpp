...
TEST_CASE("HeatMap: normal grid/world some invalid values", "[HeatMap]") {
  ...
  test_log.LogAction(1, "move", cse498::WorldPosition{9, 9},
                     cse498::WorldPosition{0, 0});
  test_log.LogAction(1, "move", cse498::WorldPosition{-1, 4},
                     cse498::WorldPosition{0, 0});
  test_log.LogAction(1, "move", cse498::WorldPosition{9, -1},
                     cse498::WorldPosition{0, 0});
  test_log.LogAction(1, "move", cse498::WorldPosition{1, 11},
                     cse498::WorldPosition{0, 0});
  test_log.LogAction(1, "move", cse498::WorldPosition{11, 1},
                     cse498::WorldPosition{0, 0});

  cse498::HeatMap map2(test_log, std::pair<int, int>{5, 5},
...
TEST_CASE("HeatMap: large grid/world some invalid values", "[HeatMap]") {
  ...
  cse498::HeatMap map4(test_log, std::pair<int, int>{100, 100},
                       std::pair<int, int>{20000, 20000});
...
TEST_CASE("HeatMap: uneven grid/world some invalid values", "[HeatMap]") {
  ...
  cse498::HeatMap map6(test_log, std::pair<int, int>{5, 2},
...
TEST_CASE("HeatMap: Adding second log to Heatmap", "[HeatMap]") {
  ...
  cse498::HeatMap map9(test_log, std::pair<int, int>{5, 5},
                       std::pair<int, int>{10, 10});
  ...
  second_log.LogAction(1, "move", cse498::WorldPosition{9, -1},
                       cse498::WorldPosition{0, 0});
  second_log.LogAction(1, "move", cse498::WorldPosition{1, 11},
                       cse498::WorldPosition{0, 0});
  second_log.LogAction(1, "move", cse498::WorldPosition{11, 1},
                       cse498::WorldPosition{0, 0});
