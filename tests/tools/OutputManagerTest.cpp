...
/* @brief Tests for OutputManager::Log behavior with category filtering,
 * formatting, and timestamp toggling
 */
...
TEST_CASE(
  ...
  SECTION("Puzzle category") {
    CoutCapture cap;
    om.Log(cse498::LogLevel::Info, cse498::LogCategory::Puzzle,
           "Player solved riddle");
    const std::string out = cap.Str();
...
/* @brief Tests for OutputManager sink behavior, including filtering,
 * formatting, and timestamp toggling
 */
TEST_CASE("OutputManager sink behavior (Step 3)", "[output][sink]") {
  ...
  // Force logs to the vector for testing by clearing default sinks and adding a
  // custom one
  om.ClearSinks();
...
// TEST_CASE("Visual timestamp demo (prints to console)",
// "[output][manual][visual]")
// {
//     cse498::OutputManager om;
...
//     om.Log(cse498::LogLevel::Info, cse498::LogCategory::System, "Visual test:
//     first message");
 ...
 */
TEST_CASE("CSV path validation throws on invalid inputs",
          "[output][csv][errors]") {
  cse498::OutputManager om;
...
// /* @brief Tests for OutputManager CSV exporting, including header writing and
// row formatting
// */
// TEST_CASE("CSV switching paths writes to both files correctly",
// "[output][csv][switch]")
// {
//     cse498::OutputManager om;
//     om.SetMinLogLevel(cse498::LogLevel::Info);
...
//     om.Log(cse498::LogLevel::Info, cse498::LogCategory::System, "CSV Test
//     Message 1"); om.Log(cse498::LogLevel::Error, cse498::LogCategory::AI,
//     "CSV Test Message 2");
