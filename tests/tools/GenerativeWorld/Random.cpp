...
TEST_CASE("Test Random Integer Generation with Set Seed", "[core]") {
  ...
  CHECK(std::any_of(generations_int.begin() + 1, generations_int.end(),
                    [&](const auto &x) { return x != generations_int[0]; }));
  ...
  CHECK(std::any_of(
      generations_int_large.begin() + 1, generations_int_large.end(),
      [&](const auto &x) { return x != generations_int_large[0]; }));
  ...
  CHECK(std::any_of(
      generations_int_small.begin() + 1, generations_int_small.end(),
      [&](const auto &x) { return x != generations_int_small[0]; }));
  ...
  CHECK(
      std::any_of(generations_int_neg.begin() + 1, generations_int_neg.end(),
                  [&](const auto &x) { return x != generations_int_neg[0]; }));
}
...
TEST_CASE("Test Random Double Generation with Set Seed", "[core]") {
  ...
  CHECK(std::any_of(generations_double.begin() + 1, generations_double.end(),
                    [&](const auto &x) { return x != generations_double[0]; }));
  ...
  CHECK(std::any_of(
      generations_double_large.begin() + 1, generations_double_large.end(),
      [&](const auto &x) { return x != generations_double_large[0]; }));
  ...
  CHECK(std::any_of(
      generations_double_small.begin() + 1, generations_double_small.end(),
      [&](const auto &x) { return x != generations_double_small[0]; }));
  ...
  CHECK(std::any_of(
      generations_double_neg.begin() + 1, generations_double_neg.end(),
      [&](const auto &x) { return x != generations_double_neg[0]; }));
}
...
TEST_CASE("Test Random Float Generation with Set Seed", "[core]") {
  ...
  CHECK(std::any_of(generations_float.begin() + 1, generations_float.end(),
                    [&](const auto &x) { return x != generations_float[0]; }));
  ...
  CHECK(std::any_of(
      generations_float_large.begin() + 1, generations_float_large.end(),
      [&](const auto &x) { return x != generations_float_large[0]; }));
  ...
  CHECK(std::any_of(
      generations_float_small.begin() + 1, generations_float_small.end(),
      [&](const auto &x) { return x != generations_float_small[0]; }));
  ...
  CHECK(std::any_of(
      generations_float_neg.begin() + 1, generations_float_neg.end(),
      [&](const auto &x) { return x != generations_float_neg[0]; }));
}
...
TEST_CASE("Test Random Char Generation with Set Seed", "[core]") {
  ...
  CHECK(std::any_of(generations_char.begin() + 1, generations_char.end(),
                    [&](const auto &x) { return x != generations_char[0]; }));
  ...
  CHECK(std::any_of(
      generations_char_large.begin() + 1, generations_char_large.end(),
      [&](const auto &x) { return x != generations_char_large[0]; }));
  ...
  CHECK(std::any_of(
      generations_char_small.begin() + 1, generations_char_small.end(),
      [&](const auto &x) { return x != generations_char_small[0]; }));
...
TEST_CASE("Test Random Boolean Generation with Set Seed", "[core]") {
  ...
  CHECK(std::any_of(generations_bool.begin() + 1, generations_bool.end(),
                    [&](const auto &x) { return x != generations_bool[0]; }));
}
...
TEST_CASE("Test Random Proability Generation with Set Seed", "[core]") {
  ...
  CHECK(std::any_of(generations_p.begin() + 1, generations_p.end(),
                    [&](const auto &x) { return x != generations_p[0]; }));
  ...
  CHECK(
      std::any_of(generations_p_small.begin() + 1, generations_p_small.end(),
                  [&](const auto &x) { return x != generations_p_small[0]; }));
  ...
  CHECK(
      std::any_of(generations_p_large.begin() + 1, generations_p_large.end(),
                  [&](const auto &x) { return x != generations_p_large[0]; }));
...
TEST_CASE("Test Random Integer Generation Reproducability with Same Seed",
          "[core]") {
  //// Check that it is randomly generating numbers with a set seed
  cse498::Random ran15;
  ran15.SetSeed(1000);
...
TEST_CASE("Test Random Double Generation Reproducability with Same Seed",
          "[core]") {
  //// Check that it is randomly generating numbers with a set seed
  cse498::Random ran17;
  ran17.SetSeed(1000);
  ...
  REQUIRE(generations_double_large_1.size() ==
          generations_double_large_2.size());
...
TEST_CASE("Test Random Float Generation Reproducability with Same Seed",
          "[core]") {
  //// Check that it is randomly generating numbers with a set seed
  cse498::Random ran19;
  ran19.SetSeed(1000);
...
TEST_CASE("Test Random Char Generation Reproducability with Same Seed",
          "[core]") {
  //// Check that it is randomly generating numbers with a set seed
  cse498::Random ran21;
  ran21.SetSeed(1000);
...
TEST_CASE("Test Random Boolean Generation Reproducability with Same Seed",
          "[core]") {
  //// Check that it is randomly generating numbers with a set seed
  cse498::Random ran23;
  ran23.SetSeed(1000);
...
TEST_CASE("Test Random Proability Generation Reproducability with Same Seed",
          "[core]") {
  //// Check that it is randomly generating numbers with a set seed
  cse498::Random ran25;
  ran25.SetSeed(1000);
