...
TEST_CASE("Blackboard: Get with default value for missing key",
          "[Blackboard]") {
  Blackboard bb;
...
TEST_CASE("Action: Returns correct status", "[Action]") {
  ...
  Action successAction(
      "Success", [](ExecutionContext &) { return Node::Status::Success; });
  Action failAction("Fail",
                    [](ExecutionContext &) { return Node::Status::Failure; });
  Action runningAction(
      "Running", [](ExecutionContext &) { return Node::Status::Running; });
...
TEST_CASE("Action: Conditional status based on blackboard", "[Action]") {
  ...
  Action action("Conditional", [](ExecutionContext &ctx) {
    return ctx.blackboard.Get<bool>("flag", false) ? Node::Status::Success
                                                   : Node::Status::Failure;
  });
...
TEST_CASE("Selector: Returns Success on first successful child", "[Selector]") {
  ...
  sel.AddChild(std::make_unique<Action>(
      "Fail", [](ExecutionContext &) { return Node::Status::Failure; }));
  sel.AddChild(std::make_unique<Action>(
      "Success", [](ExecutionContext &) { return Node::Status::Success; }));
...
TEST_CASE("Selector: Returns Failure when all children fail", "[Selector]") {
  ...
  sel.AddChild(std::make_unique<Action>(
      "Fail1", [](ExecutionContext &) { return Node::Status::Failure; }));
  sel.AddChild(std::make_unique<Action>(
      "Fail2", [](ExecutionContext &) { return Node::Status::Failure; }));
...
TEST_CASE("Selector: Short-circuits on first success", "[Selector]") {
  ...
  sel.AddChild(std::make_unique<Action>("Success", [](ExecutionContext &ctx) {
    ctx.blackboard.Set<int>("visited",
                            ctx.blackboard.Get<int>("visited", 0) + 1);
    return Node::Status::Success;
  }));
  sel.AddChild(
      std::make_unique<Action>("ShouldNotRun", [](ExecutionContext &ctx) {
        ctx.blackboard.Set<int>("visited",
                                ctx.blackboard.Get<int>("visited", 0) + 10);
        return Node::Status::Success;
      }));
...
TEST_CASE("Selector: Resumes from beginning after Reset", "[Selector]") {
  ...
  sel.AddChild(std::make_unique<Action>(
      "Fail", [](ExecutionContext &) { return Node::Status::Failure; }));
  sel.AddChild(
      std::make_unique<Action>("Running", [&callCount](ExecutionContext &) {
        callCount++;
...
TEST_CASE("Selector: GetChildren returns correct count", "[Selector]") {
  ...
  sel.AddChild(std::make_unique<Action>(
      "A", [](ExecutionContext &) { return Node::Status::Success; }));
  sel.AddChild(std::make_unique<Action>(
      "B", [](ExecutionContext &) { return Node::Status::Success; }));
...
TEST_CASE("Sequence: Returns Success when all children succeed", "[Sequence]") {
  ...
  seq.AddChild(std::make_unique<Action>(
      "Success1", [](ExecutionContext &) { return Node::Status::Success; }));
  seq.AddChild(std::make_unique<Action>(
      "Success2", [](ExecutionContext &) { return Node::Status::Success; }));
...
TEST_CASE("Sequence: Resumes from beginning after Reset", "[Sequence]") {
  ...
  seq.AddChild(
      std::make_unique<Action>("Counter", [&callCount](ExecutionContext &) {
        callCount++;
        return Node::Status::Success;
      }));
  seq.AddChild(std::make_unique<Action>(
...
TEST_CASE("Invert: Inverts Success to Failure", "[Invert]") {
  ...
  inv.SetChild(std::make_unique<Action>(
      "Success", [](ExecutionContext &) { return Node::Status::Success; }));
...
TEST_CASE("Invert: GetChild returns set child", "[Invert]") {
  ...
  inv.SetChild(std::make_unique<Action>(
      "Child", [](ExecutionContext &) { return Node::Status::Success; }));
...
TEST_CASE("ContinuallyRepeat: Always returns Running on Success child",
          "[ContinuallyRepeat]") {
  Blackboard bb;
  ExecutionContext ctx(bb);

  ContinuallyRepeat repeat("TestRepeat");
  repeat.SetChild(std::make_unique<Action>(
      "Success", [](ExecutionContext &) { return Node::Status::Success; }));
...
TEST_CASE("ContinuallyRepeat: Always returns Running on Failure child",
          "[ContinuallyRepeat]") {
  Blackboard bb;
  ExecutionContext ctx(bb);
...
TEST_CASE("ContinuallyRepeat: No child returns Running",
          "[ContinuallyRepeat]") {
  Blackboard bb;
  ExecutionContext ctx(bb);
...
TEST_CASE("ContinuallyRepeat: Child action is called repeatedly",
          "[ContinuallyRepeat]") {
  Blackboard bb;
  ExecutionContext ctx(bb);
  ...
  repeat.SetChild(
      std::make_unique<Action>("Counter", [](ExecutionContext &ctx) {
        int value = ctx.blackboard.Get<int>("counter", 0);
        ctx.blackboard.Set<int>("counter", value + 1);
        return Node::Status::Success;
      }));
...
TEST_CASE("ContinuallyRepeat: GetName returns correct name",
          "[ContinuallyRepeat]") {
  ContinuallyRepeat repeat("MyRepeat");
  REQUIRE(repeat.GetName() == "MyRepeat");
}

TEST_CASE("ContinuallyRepeat: Still Running when child is Running",
          "[ContinuallyRepeat]") {
  Blackboard bb;
  ExecutionContext ctx(bb);
...
TEST_CASE("ContinuallyRepeat: GetChild returns set child",
          "[ContinuallyRepeat]") {
...
TEST_CASE("TreeBuilder: Creates nodes correctly", "[TreeBuilder]") {
  ...
  auto act = TreeBuilder::Act(
      "TestAction", [](ExecutionContext &) { return Node::Status::Success; });
...
TEST_CASE("TreeBuilder: Act node executes correctly", "[TreeBuilder]") {
  ...
  auto act = TreeBuilder::Act(
      "ActNode", [](ExecutionContext &) { return Node::Status::Success; });

  REQUIRE(act->Tick(ctx) == Node::Status::Success);
}

TEST_CASE("TreeBuilder: Seq node with children executes correctly",
          "[TreeBuilder]") {
  Blackboard bb;
  ExecutionContext ctx(bb);

  auto seq = TreeBuilder::Seq("BuiltSeq");
  seq->AddChild(TreeBuilder::Act(
      "A", [](ExecutionContext &) { return Node::Status::Success; }));
  seq->AddChild(TreeBuilder::Act(
      "B", [](ExecutionContext &) { return Node::Status::Success; }));
...
TEST_CASE("TreeBuilder: Sel node with children executes correctly",
          "[TreeBuilder]") {
  Blackboard bb;
  ExecutionContext ctx(bb);

  auto sel = TreeBuilder::Sel("BuiltSel");
  sel->AddChild(TreeBuilder::Act(
      "Fail", [](ExecutionContext &) { return Node::Status::Failure; }));
  sel->AddChild(TreeBuilder::Act(
      "Success", [](ExecutionContext &) { return Node::Status::Success; }));
...
TEST_CASE("Integration: Selector with Sequences as children", "[Integration]") {
  ...
  shootSeq->AddChild(TreeBuilder::Act("CheckAmmo", [](ExecutionContext &ctx) {
    return ctx.blackboard.Get<bool>("hasAmmo", false) ? Node::Status::Success
                                                      : Node::Status::Failure;
  }));
  ...
  meleeSeq->AddChild(TreeBuilder::Act("CheckMelee", [](ExecutionContext &ctx) {
    return ctx.blackboard.Get<bool>("canMelee", false) ? Node::Status::Success
                                                       : Node::Status::Failure;
  }));
...
TEST_CASE("Integration: Invert used as condition guard in Sequence",
          "[Integration]") {
  Blackboard bb;
  ExecutionContext ctx(bb);
  ...
  inv->SetChild(TreeBuilder::Act("IsDead", [](ExecutionContext &ctx) {
    return ctx.blackboard.Get<bool>("isDead", false) ? Node::Status::Success
                                                     : Node::Status::Failure;
  }));
...
TEST_CASE("Integration: ContinuallyRepeat wrapping a Sequence",
          "[Integration]") {
  Blackboard bb;
  ExecutionContext ctx(bb);
...
TEST_CASE("Integration: Deep nested tree executes correctly", "[Integration]") {
  ...
  innerSel->AddChild(TreeBuilder::Act(
      "Fail", [](ExecutionContext &) { return Node::Status::Failure; }));
  innerSel->AddChild(TreeBuilder::Act(
      "Success", [](ExecutionContext &) { return Node::Status::Success; }));
