...
TEST_CASE("Action: Conditional status based on blackboard", "[Action]") {
    ...
    Action action("Conditional", [](ExecutionContext& ctx) {
        return ctx.mBlackboard.Get<bool>("flag", false) ? Node::Status::Success : Node::Status::Failure;
    });
...
TEST_CASE("Selector: Returns Success on first successful child", "[Selector]") {
    ...
    sel.AddChild(std::make_unique<Action>("Fail", [](ExecutionContext&) { return Node::Status::Failure; }));
    sel.AddChild(std::make_unique<Action>("Success", [](ExecutionContext&) { return Node::Status::Success; }));
...
TEST_CASE("Selector: Returns Failure when all children fail", "[Selector]") {
    ...
    sel.AddChild(std::make_unique<Action>("Fail1", [](ExecutionContext&) { return Node::Status::Failure; }));
    sel.AddChild(std::make_unique<Action>("Fail2", [](ExecutionContext&) { return Node::Status::Failure; }));
...
TEST_CASE("Selector: Returns Running when child is running", "[Selector]") {
    ...
    sel.AddChild(std::make_unique<Action>("Fail", [](ExecutionContext&) { return Node::Status::Failure; }));
    sel.AddChild(std::make_unique<Action>("Running", [](ExecutionContext&) { return Node::Status::Running; }));
...
TEST_CASE("Selector: Short-circuits on first success", "[Selector]") {
    ...
    sel.AddChild(std::make_unique<Action>("Success", [](ExecutionContext& ctx) {
        ctx.mBlackboard.Set<int>("visited", ctx.mBlackboard.Get<int>("visited", 0) + 1);
        return Node::Status::Success;
    }));
    sel.AddChild(std::make_unique<Action>("ShouldNotRun", [](ExecutionContext& ctx) {
...
TEST_CASE("Selector: Resumes from beginning after Reset", "[Selector]") {
    ...
    sel.AddChild(std::make_unique<Action>("Fail", [](ExecutionContext&) { return Node::Status::Failure; }));
    sel.AddChild(std::make_unique<Action>("Running", [&callCount](ExecutionContext&) {
        callCount++;
...
TEST_CASE("Selector: GetChildren returns correct count", "[Selector]") {
    ...
    sel.AddChild(std::make_unique<Action>("A", [](ExecutionContext&) { return Node::Status::Success; }));
    sel.AddChild(std::make_unique<Action>("B", [](ExecutionContext&) { return Node::Status::Success; }));
...
TEST_CASE("Sequence: Returns Success when all children succeed", "[Sequence]") {
    ...
    seq.AddChild(std::make_unique<Action>("Success1", [](ExecutionContext&) { return Node::Status::Success; }));
    seq.AddChild(std::make_unique<Action>("Success2", [](ExecutionContext&) { return Node::Status::Success; }));
...
TEST_CASE("Sequence: Returns Failure on first failing child", "[Sequence]") {
    ...
    seq.AddChild(std::make_unique<Action>("Success", [](ExecutionContext&) { return Node::Status::Success; }));
    seq.AddChild(std::make_unique<Action>("Fail", [](ExecutionContext&) { return Node::Status::Failure; }));
...
TEST_CASE("Sequence: Returns Running when child is Running", "[Sequence]") {
    ...
    seq.AddChild(std::make_unique<Action>("Success", [](ExecutionContext&) { return Node::Status::Success; }));
    seq.AddChild(std::make_unique<Action>("Running", [](ExecutionContext&) { return Node::Status::Running; }));
...
TEST_CASE("Sequence: Short-circuits on first failure", "[Sequence]") {
    ...
    seq.AddChild(std::make_unique<Action>("Fail", [](ExecutionContext& ctx) {
        ctx.mBlackboard.Set<int>("visited", ctx.mBlackboard.Get<int>("visited", 0) + 1);
        return Node::Status::Failure;
    }));
    seq.AddChild(std::make_unique<Action>("ShouldNotRun", [](ExecutionContext& ctx) {
        ctx.mBlackboard.Set<int>("visited", ctx.mBlackboard.Get<int>("visited", 0) + 10);
        return Node::Status::Success;
    }));
...
TEST_CASE("Sequence: Resumes from beginning after Reset", "[Sequence]") {
    ...
    seq.AddChild(std::make_unique<Action>("Counter", [&callCount](ExecutionContext&) {
        callCount++;
        return Node::Status::Success;
    }));
    seq.AddChild(std::make_unique<Action>("Running", [](ExecutionContext&) { return Node::Status::Running; }));
...
TEST_CASE("Sequence: GetChildren returns correct count", "[Sequence]") {
    ...
    seq.AddChild(std::make_unique<Action>("A", [](ExecutionContext&) { return Node::Status::Success; }));
    seq.AddChild(std::make_unique<Action>("B", [](ExecutionContext&) { return Node::Status::Success; }));
...
TEST_CASE("Invert: Inverts Success to Failure", "[Invert]") {
    ...
    inv.SetChild(std::make_unique<Action>("Success", [](ExecutionContext&) { return Node::Status::Success; }));
...
TEST_CASE("Invert: Inverts Failure to Success", "[Invert]") {
    ...
    Invert inv("TestInvert");
    inv.SetChild(std::make_unique<Action>("Fail", [](ExecutionContext&) { return Node::Status::Failure; }));
...
TEST_CASE("Invert: Passes through Running unchanged", "[Invert]") {
    ...
    Invert inv("TestInvert");
    inv.SetChild(std::make_unique<Action>("Running", [](ExecutionContext&) { return Node::Status::Running; }));
...
TEST_CASE("Invert: GetChild returns set child", "[Invert]") {
    ...
    inv.SetChild(std::make_unique<Action>("Child", [](ExecutionContext&) { return Node::Status::Success; }));
...
TEST_CASE("ContinuallyRepeat: Always returns Running on Success child", "[ContinuallyRepeat]") {
    ...
    repeat.SetChild(std::make_unique<Action>("Success", [](ExecutionContext&) { return Node::Status::Success; }));
...
TEST_CASE("ContinuallyRepeat: Always returns Running on Failure child", "[ContinuallyRepeat]") {
    ...
    ContinuallyRepeat repeat("TestRepeat");
    repeat.SetChild(std::make_unique<Action>("Fail", [](ExecutionContext&) { return Node::Status::Failure; }));
...
TEST_CASE("ContinuallyRepeat: Still Running when child is Running", "[ContinuallyRepeat]") {
    ...
    repeat.SetChild(std::make_unique<Action>("Running", [](ExecutionContext&) { return Node::Status::Running; }));
...
TEST_CASE("ContinuallyRepeat: GetChild returns set child", "[ContinuallyRepeat]") {
    ...
    repeat.SetChild(std::make_unique<Action>("Child", [](ExecutionContext&) { return Node::Status::Success; }));
...
TEST_CASE("TreeBuilder: Creates nodes correctly", "[TreeBuilder]") {
    ...
    auto act = TreeBuilder::Act("TestAction", [](ExecutionContext&) { return Node::Status::Success; });
...
TEST_CASE("TreeBuilder: Act node executes correctly", "[TreeBuilder]") {
    ...
    auto act = TreeBuilder::Act("ActNode", [](ExecutionContext&) { return Node::Status::Success; });
...
TEST_CASE("Integration: Selector with Sequences as children", "[Integration]") {
    ...
    shootSeq->AddChild(TreeBuilder::Act("CheckAmmo", [](ExecutionContext& ctx) {
        return ctx.mBlackboard.Get<bool>("hasAmmo", false) ? Node::Status::Success : Node::Status::Failure;
    }));
    ...
    meleeSeq->AddChild(TreeBuilder::Act("CheckMelee", [](ExecutionContext& ctx) {
        return ctx.mBlackboard.Get<bool>("canMelee", false) ? Node::Status::Success : Node::Status::Failure;
    }));
...
TEST_CASE("Integration: Invert used as condition guard in Sequence", "[Integration]") {
    ...
    inv->SetChild(TreeBuilder::Act("IsDead", [](ExecutionContext& ctx) {
        return ctx.mBlackboard.Get<bool>("isDead", false) ? Node::Status::Success : Node::Status::Failure;
    }));
...
TEST_CASE("Integration: Deep nested tree executes correctly", "[Integration]") {
    ...
    innerSel->AddChild(TreeBuilder::Act("Fail", [](ExecutionContext&) { return Node::Status::Failure; }));
    innerSel->AddChild(TreeBuilder::Act("Success", [](ExecutionContext&) { return Node::Status::Success; }));
