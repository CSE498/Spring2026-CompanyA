...
TEST_CASE("FeatureVector default constructor initializes all values to zero", "[FeatureVector]") {
    TestVector fv;
...
TEST_CASE("FeatureVector initializer list constructor stores values correctly", "[FeatureVector]") {
...
TEST_CASE("FeatureVector equality and inequality operators work", "[FeatureVector]") {
...
TEST_CASE("FeatureVector scalar multiplication works correctly", "[FeatureVector]") {
    TestVector a{1.0, 2.0, 3.0, 4.0};
...
TEST_CASE("FeatureVector compound assignment operators work correctly", "[FeatureVector]") {
    TestVector a{1.0, 2.0, 3.0, 4.0};
    TestVector b{10.0, 20.0, 30.0, 40.0};
...
TEST_CASE("FeatureVector normalize scales vector to unit length", "[FeatureVector]") {
...
TEST_CASE("FeatureVector normalize leaves zero vector unchanged", "[FeatureVector]") {
