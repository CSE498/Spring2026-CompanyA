...
TEST_CASE("Test ErrorManager RaiseTerminalError Does Not Stop Execution",
          "[ErrorManager]") {
  cse498::ErrorManager em;
  StderrCapture capture;
...
TEST_CASE("Test ErrorManager RaiseTerminalWarning Does Not Stop Execution",
          "[ErrorManager]") {
  cse498::ErrorManager em;
  StderrCapture capture;
...
TEST_CASE("Test ErrorManager LogError Does Not Stop Execution",
          "[ErrorManager]") {
  cse498::ErrorManager em;
  StderrCapture capture;
...
TEST_CASE("Test ErrorManager LogWarning Does Not Stop Execution",
          "[ErrorManager]") {
  cse498::ErrorManager em;
  StderrCapture capture;
...
TEST_CASE("Test ErrorManager Multiple Non-Fatal Errors Continue Execution",
          "[ErrorManager]") {
  cse498::ErrorManager em;
  StderrCapture capture;
...
/// This function intentionally kills the program - this would interrupt the
/// testing suite as well I believe. For that reason, it's left here as a
/// placeholder in case in the future a more meaningful test is thought of.
