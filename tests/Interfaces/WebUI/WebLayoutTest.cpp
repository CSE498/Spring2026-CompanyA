...
public:
  ...
  void Unmount() noexcept override { unmountCount++; }
...
//     // Since mNextIdCounter is static and private, we can't directly reset
//     it.
...
TEST_CASE("WebLayout constructor with explicit ID",
          "[weblayout][constructor]") {
  WebLayout layout("my-custom-layout");
  REQUIRE(layout.Id() == "my-custom-layout");
}

TEST_CASE("WebLayout destructor is safe and idempotent",
          "[weblayout][destructor]") {
...
TEST_CASE("WebLayout SetLayoutType stores and applies correctly",
...
TEST_CASE("WebLayout SetJustification stores multiple values",
          "[weblayout][layout-config]") {
  WebLayout layout("justification-test");

  std::vector<Justification> justifications = {
      Justification::Start,       Justification::Center,
      Justification::End,         Justification::SpaceBetween,
      Justification::SpaceAround, Justification::SpaceEvenly};
...
TEST_CASE("WebLayout SetAlignItems stores alignment values",
          "[weblayout][layout-config]") {
  WebLayout layout("align-items-test");

  std::vector<Alignment> alignments = {Alignment::None, Alignment::Start,
...
TEST_CASE("WebLayout AddElement with null pointer returns false",
          "[weblayout][children]") {
  WebLayout layout("add-null-test");
  REQUIRE(layout.AddElement(nullptr) == false);
}

TEST_CASE("WebLayout AddElement with invalid element ID returns false",
          "[weblayout][children]") {
...
TEST_CASE("WebLayout can add and remove single element",
          "[weblayout][children]") {
...
TEST_CASE("WebLayout RemoveElement returns false for non-existent element",
          "[weblayout][children]") {
...
TEST_CASE("WebLayout RemoveElement with null pointer returns false",
          "[weblayout][children]") {
  WebLayout layout("remove-null-test");
  REQUIRE(layout.RemoveElement(nullptr) == false);
}

TEST_CASE("WebLayout SetAlignment on non-existent element is safe",
          "[weblayout][children]") {
...
TEST_CASE("WebLayout SetAlignment on added element works",
          "[weblayout][children]") {
...
TEST_CASE("WebLayout SetSpacing stores positive values",
          "[weblayout][styling]") {
...
TEST_CASE("WebLayout SetBackgroundColor stores colors",
          "[weblayout][styling]") {
  WebLayout layout("bg-color-test");

  std::vector<std::string> colors = {
      "#ffffff",    "#000000", "red", "rgb(255, 0, 0)", "rgba(255, 0, 0, 0.5)",
      "transparent"};
...
TEST_CASE("WebLayout SetBorderWidth stores positive values",
          "[weblayout][styling]") {
...
TEST_CASE("WebLayout SetBorderRadius stores positive values",
          "[weblayout][styling]") {
...
TEST_CASE("WebLayout SetPadding stores positive values",
          "[weblayout][styling]") {
...
TEST_CASE("WebLayout SetMargin stores positive values",
          "[weblayout][styling]") {
...
TEST_CASE("WebLayout SetHeight stores positive values",
          "[weblayout][styling]") {
...
TEST_CASE("WebLayout SetOpacity stores values in valid range",
          "[weblayout][styling]") {
...
TEST_CASE("WebLayout SetBoxShadow stores shadow strings",
          "[weblayout][styling]") {
  WebLayout layout("box-shadow-test");

  std::vector<std::string> shadows = {"0 4px 6px rgba(0, 0, 0, 0.1)",
                                      "0 0 10px #000000",
...
TEST_CASE("WebLayout ToggleVisibility toggles state",
          "[weblayout][visibility]") {
...
TEST_CASE("WebLayout ToggleVisibility multiple times",
          "[weblayout][visibility]") {
...
TEST_CASE("WebLayout complex styling scenario",
          "[weblayout][styling][integration]") {
...
TEST_CASE("IDomElement grid position helpers work correctly",
...
TEST_CASE("IDomElement grid position with large indices",
          "[weblayout][positioning][grid]") {
...
TEST_CASE("WebLayout applies grid positions to children",
          "[weblayout][positioning][grid]") {
...
TEST_CASE("IDomElement free position helpers work correctly",
...
TEST_CASE("IDomElement free position with zero coordinates",
          "[weblayout][positioning][free]") {
...
TEST_CASE("IDomElement free position with large coordinates",
          "[weblayout][positioning][free]") {
...
TEST_CASE("WebLayout applies free positions to children",
          "[weblayout][positioning][free]") {
...
TEST_CASE("WebLayout SetPadding and SetMargin with zero",
          "[weblayout][edge-case]") {
...
TEST_CASE("WebLayout remove same element multiple times",
          "[weblayout][edge-case]") {
...
TEST_CASE("WebLayout SetAlignment on untrack element is safe",
          "[weblayout][edge-case]") {
...
TEST_CASE("WebLayout consecutive Clear calls are safe",
          "[weblayout][edge-case]") {
...
TEST_CASE("WebLayout preserves styling through multiple Apply calls",
          "[weblayout][state]") {
...
TEST_CASE("WebLayout preserves child order through operations",
          "[weblayout][state]") {
...
TEST_CASE("WebLayout maintains all layout configurations through operations",
          "[weblayout][state]") {
